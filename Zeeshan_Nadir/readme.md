...
We know that if the pedestrian in the image is too big, we can downsample the image to fit the pedestrians in out standard window size (e.g., 128x64). However, what to do if the pedestrian's size is too small? For example, how do we detect a pedestrianm whose size is 64x32? 
...
![hierarchy_of_pedestrians](https://user-images.githubusercontent.com/29146711/29387775-4d7d893e-82a7-11e7-81fb-ab62dba860da.png)
